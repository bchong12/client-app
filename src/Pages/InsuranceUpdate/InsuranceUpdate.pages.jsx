...
const InsuranceUpdate = (props) => {
  ...
  useEffect(() => {
    axios
      .get(`/application/${props.match.params.applicationId}`)
      .then((res) => {
  ...
  return (
    <>
      <Header
        ...
        middle="Applications"
        right="Client"
        linkMiddle={`/client/${clientId}/application`}
        linkRight={`/client/${clientId}`}
      />
          ...
          <div className="beginning-of-form">
            ...
            <div className="flex insurance-entry-row">
              <div className="flex-row">
                ...
                <input
                  ...
                  className="mls insurance-form-input"
                  autoComplete="false"
                  placeholder="XXXX Address Ave., City, State, Zipcode"
                />
              </div>
              <div className="flex-row">
            ...
            <div className="flex insurance-entry-row">
              <div className="mobile-font flex-row">
                ...
                <input
                  ...
                  checked={"Chronic" === livingBenefits}
                  type="checkbox"
                />
                <p>/</p>
                ...
                <input
                  ...
                  checked={"Critical" === livingBenefits}
                  type="checkbox"
                />
                <p>/</p>
                ...
                <input
                  ...
                  checked={"Terminal" === livingBenefits}
                  type="checkbox"
                />
              </div>
              <div className="flex-row">
            ...
            <div className="flex insurance-entry-row">
              ...
              <div className="margins-left margins-bottom-cancel flex-column">
                <p>
                  Using funds from existing policies to pay premiums due on the
                  new policy? If yes, transfer / 1035 form
                </p>
                <div className="flex-row">
                  <p className="mls">Y</p>
                  <input
              ...
              <div className="flex-column-center">
                ...
                <div className="flex-row">
                  ...
                  <input
                    ...
                    defaultValue={ssnPb}
                    placeholder="#"
                    className="margins-slight-left long insurance-form-input"
                  />
                </div>
                <div className="flex-row">
                  <p>Relationship:</p>
            ...
            <div className="flex insurance-entry-row">
              ...
              <input
                ...
                defaultValue={fail}
                placeholder="Age if Living"
                className="margins-bigger-left short insurance-form-input"
              />
              <input
                onChange={(e) => {
                ...
                className="margins-bigger-left-2 short insurance-form-input"
              />
              <input
                onChange={(e) => {
                ...
                className="margins-bigger-left-3 short insurance-form-input"
              />
            </div>
            <div className="flex insurance-entry-row">
              <p>Mother</p>
              <input
                ...
                defaultValue={mail}
                placeholder="Age if Living"
                className="margins-bigger-left-4 short insurance-form-input"
              />
              <input
                onChange={(e) => {
            ...
            <div className="flex insurance-entry-row">
              ...
              <input
                ...
                defaultValue={bsail}
                placeholder="Age if Living"
                className="margins-big-left-2 short insurance-form-input"
              />
              <input
                onChange={(e) => {
            ...
            <div className="flex insurance-entry-row">
              <p>
                Any moving violation/DUI/license suspension in the past 3 years?
              </p>
            </div>
            <div className="flex insurance-entry-row">
              <p className="mls">If yes, please describe</p>
            ...
            <div className="flex insurance-entry-row">
              <div className="flex-row">
                ...
                <input
                  ...
                  defaultValue={examScheduledDate}
                  className="mls insurance-form-input"
                />
              </div>
              <div className="flex-row">
            ...
            <div className="margins-top margins-biggest-left">
              <button
                ...
                className="mls thick login-button"
              >
                Submit
              </button>
              <button
