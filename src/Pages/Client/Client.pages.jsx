...
const Client = (props) => {
  ...
  return (
    <>
      <Header left='Agent name' middle='Applications' right='Meetings' linkMiddle={`/client/${clientId}/application`} linkRight={`/client/${clientId}/meeting`} />
      <div className="client">
        <div className="nice client-page input-box">
          ...
          <div className="info-tag-div">
            ...
            <div className="info-tag">
              <p>Phone Number:</p> <p>{phoneNumber}</p>
            </div>
          </div>
          <button onClick={() => {
            props.history.push(`/client/${clientId}/edit`)
